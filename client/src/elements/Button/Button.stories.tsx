...
//     'Font size',
//     { fine: 'fine', xs: 'xs', sm: 'sm', 'md (default)': 'md', lg: 'lg', xl: 'xl' },
//     'md',
//     'Props',
//   )

//   const icon = select('Icon', { '(none)': '', ...iconOptions }, 'add', 'Props') as IconSymbol
...
//           iconRight={iconRight && ICON_MAP[iconRight]}
//           justify={justify}
//           mode={mode}
//           onClick={action('onClick')}
//           paddingX={paddingX}
...
// export const styledButton1 = () => {
//   return <Button as={StyledButton1} href="#" mode="outline" icon="add" label="Create" />
// }
