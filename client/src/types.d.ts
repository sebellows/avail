...
// declare type ObjectType<T = any> = Record<string, T>
...
//  * ]
//  */
// // declare type CSSObject<T = Primitive> = ObjectType<T> | ObjectType<ObjectType<T>>
// declare type CSSObject<T = Primitive> = StyledCSSObject & (ObjectType<T> | ObjectType<ObjectType<T>>)
